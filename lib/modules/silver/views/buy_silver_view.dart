...
class _BuySilverViewState extends State<BuySilverView> {
  ...
  SilverBuyInitiateResult? _pendingDirectBuy;
  ...
  void _handleRzpSuccess(PaymentSuccessResponse response) async {
    ...
    try {
      final ok = await _silverRepo.verifyBuy(
      ...
      if (ok) {
        if (_redeemedPoints > 0) {
          _pointsCtrl.redeemPoints(_redeemedPoints, 'Silver Purchase');
        }
                              ...
                              Expanded(
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: _paymentMethod == 'razorpay' ? _silver.withOpacity(0.12) : t.subBg,
                                      borderRadius: BorderRadius.circular(14),
                                      border: Border.all(
                                        color: _paymentMethod == 'razorpay' ? _silver : t.cardBorder,
                                        width: 1.5,
                                      ),
                                    ),
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Icon(
                                              Icons.bolt_rounded,
                                              color: _paymentMethod == 'razorpay' ? _silver : t.inkMuted,
                                              size: 20,
                                            ),
                                            Container(
                              ...
                              Expanded(
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 12),
                                    decoration: BoxDecoration(
                                      color: _paymentMethod == 'wallet' ? _silver.withOpacity(0.12) : t.subBg,
                                      borderRadius: BorderRadius.circular(14),
                                      border: Border.all(
                                        color: _paymentMethod == 'wallet' ? _silver : t.cardBorder,
                                        width: 1.5,
                                      ),
                                    ),
                                    child: Column(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Icon(
                                              ...
                                              color: _paymentMethod == 'wallet' ? _silver : t.inkMuted,
                                              size: 20,
                                            ),
                                            Text(
                                              '₹${_walletBal.toStringAsFixed(0)}',
                      ...
                      onTap: _valid && _agreedToTerms && !_isBuyingLocal
                          ? () async {
                              ...
                              if (_paymentMethod == 'razorpay') {
                                setState(() => _isBuyingLocal = true);
                                try {
                                  final initRes = await _silverRepo.initiateBuy(
