...
class _SellSilverViewState extends State<SellSilverView> {
  ...
  double get _available => SilverController.to.balance.value?.availableGrams ?? 0;
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 6),
                              Obx(() {
                                final chg = SilverController.to.rate.value?.change24h ?? 0;
                                final pct = SilverController.to.rate.value?.changePct ?? 0;
                                final isUp = chg >= 0;
                              ...
                              Obx(() {
                                ...
                                return Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 4),
                                    GestureDetector(
                                      onTap: () => SilverController.to.loadRate(),
                                      child: Icon(
                            ...
                            onTap: () {
                              setState(() {
                                if (_byGrams) {
                                  ...
                                  _byGrams = true;
                                  _ctrl.text = _gramsDisp > 0 ? _gramsDisp.toStringAsFixed(4) : '5.0000';
                                }
                              });
                            },
                            child: Text(
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          _chip(_byGrams ? 10.0 : 500.0, _byGrams ? '10g' : '₹500', t),
                          _chip(_byGrams ? 20.0 : 1000.0, _byGrams ? '20g' : '₹1000', t),
                          _chip(_byGrams ? 50.0 : 2000.0, _byGrams ? '50g' : '₹2000', t),
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _valid ? t.primary : t.primary.withOpacity(0.5),
                          borderRadius: BorderRadius.circular(16),
                        ),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        _trustBadge(Icons.verified_outlined, '100% Secure', 'Your silver is 100% safe', t),
