...
class SilverTransactionDetailView extends StatefulWidget {
  const SilverTransactionDetailView({super.key, required this.txn});
  final SilverTxnModel txn;

  @override
  State<SilverTransactionDetailView> createState() =>
      _SilverTransactionDetailViewState();
}

class _SilverTransactionDetailViewState
    extends State<SilverTransactionDetailView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final accent = isBuy ? const Color(0xFF8A95A5) : const Color(0xFF3B82F6);
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: isBuy
                        ? [const Color(0xFF2A2E33), const Color(0xFF6B4A00)]
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _row(
                      'Silver Value',
                      '₹${t.silverValue.toStringAsFixed(2)}',
                      tp,
                      ts,
                    ),
                    _div(border),
